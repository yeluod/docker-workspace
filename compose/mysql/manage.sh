...
DATA_DIR="/Users/wang/workspace/docker_work/mysql"
PROJECT_NAME="mysql-server"
...
Commands:
  start       Create data directory and start MySQL in background
  stop        Stop the running MySQL container
  restart     Restart the running MySQL container
...
confirm_delete() {
  local answer
  echo "This will remove the MySQL container, network, and host data directory:"
  echo "  ${DATA_DIR}"
